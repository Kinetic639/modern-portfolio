...
const About = () => {
  ...
  const experience = [
    {
      ...
      techStack: {
        ...
        column02: ["Node.js", "Express", "React Testing Library", "Gitlab"],
      },
    },
    {
      name: "givemeart",
      employerName: "GiveMeArt",
      ...
      techStack: {
        ...
        column02: ["Node.js", "Express", "Github"],
      },
    },
    {
      name: "trenujemy",
      ...
      techStack: {
        ...
        column02: ["Vue", "Node.js", "Express", "GraphQL"],
      },
    },
  ];
  ...
  return (
    <div className={styles.container}>
      ...
      >
        <motion.a href="#about-experience" className={styles.header}>
          ...
          >
            <motion.div variants={child}>
              <p className={styles.itemTitle}>
                {t(`sections.about.experience.${job.name}.position`)}
                <a
              ...
              <p className={styles.itemSubtitle}>
                {t(`sections.about.experience.${job.name}.from`)} -{" "}
                {t(`sections.about.experience.${job.name}.to`)}
              </p>
            </motion.div>
            <motion.ul variants={containerLeft} className={styles.duties}>
              {Array.from({ length: job.duties }).map((duty, index) => (
                <motion.li key={index} variants={child} className={styles.duty}>
                  ...
                  <motion.p
                    ...
                    animate="rest"
                    variants={textMotion}
                    className={styles.dutyDescription}
                  >
                    {t(
                      `sections.about.experience.${job.name}.duties.duty${index + 1}`,
                    )}
                  </motion.p>
                </motion.li>
              ))}
            ...
            <div className={styles.techstackContainer}>
              <motion.p variants={child}>
                {" "}
                {t(`sections.about.headers.usedTech`)}
              </motion.p>
      ...
      >
        ...
        >
          {t("sections.about.headers.bootcamps")}
        </motion.a>
      ...
      >
        <motion.a
          ...
          className={styles.header}
        >
          {t("sections.about.headers.positions")}
        </motion.a>
