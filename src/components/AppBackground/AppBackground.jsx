...
export const AppBackground = memo(() => {
    ...
    const [colorPrimary, setColorPrimary] = useState(getComputedStyle(document.documentElement).getPropertyValue('--font-secondary').trim());


    // this should be run only once per application lifetime
    useEffect(() => {
        const updateThemeColor = () => {
        const newColor = getComputedStyle(document.getElementById('root')).getPropertyValue('--font-secondary').trim() || '#7ab89c';
